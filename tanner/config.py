...
config_template = {'DATA': {'db_config': '/opt/tanner/db/db_config.json',
                   ...
                   'EMULATOR_ENABLED': {'sqli': False, 'rfi': True, 'lfi': False, 'xss': False, 'cmd_exec': False,
                                        'php_code_injection': False, 'php_object_injection': False, "crlf": False,
                                        "xxe_injection": False, "template_injection": False},
